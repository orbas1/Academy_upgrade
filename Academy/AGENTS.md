...
> **Completion rule:** Declare the roadmap at 100% only when every task grade is ≥95% and the aggregate average is ≥97%. Document any remediation backlog separately.

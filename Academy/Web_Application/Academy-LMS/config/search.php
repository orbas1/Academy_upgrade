    ...
    */
    ...
    'visibility' => [
        ...
        'index_filters' => [
            ...
            'comments' => "visibility IN ['public', 'community', 'paid']",
        ],
    ],
    ...
    'sync' => [
        'resources' => [
            'communities' => [
                ...
                'model' => App\Domain\Communities\Models\Community::class,
            ...
            'posts' => [
                ...
                'model' => App\Domain\Communities\Models\CommunityPost::class,
            ...
            'comments' => [
                'index' => 'comments',
                'data_source' => App\Domain\Search\DataSources\CommentDataSource::class,
                'transformer' => App\Domain\Search\Transformers\CommentSearchTransformer::class,
                'model' => App\Domain\Communities\Models\CommunityPostComment::class,
                'chunk_size' => (int) env('SEARCH_SYNC_CHUNK_COMMENTS', 500),
            ],
        ],
    ],
];
